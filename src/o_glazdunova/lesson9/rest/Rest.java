...
// ПЛАН ЗБС, НО НЕ НАДО ТАК Выводим каждого гостя отдельно,если одно и то же повторяется лучше его сделать
// методом или массивом или циклом
...
//        hello(guest3);
        ...
        for (Guest a : guests) { //каждый из гостей = а, пробегаемся по каждому гостю из массива и выводятся ссылки,
            // так не надо делать
